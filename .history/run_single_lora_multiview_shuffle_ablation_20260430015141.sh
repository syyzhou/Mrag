...
TRAIN_FILE="${TRAIN_FILE:-./datasets/${DATASET_NAME}/preprocessed/train_qa_pairs_kqt_candidates_target_poi_multiview_${VARIANT_NAME}.json}"
TEST_FILE="${TEST_FILE:-./datasets/${DATASET_NAME}/preprocessed/test_qa_pairs_kqt_candidates_target_poi_multiview_${VARIANT_NAME}.txt}"

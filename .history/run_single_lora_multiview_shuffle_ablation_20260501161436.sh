...
TRAIN_FILE="${TRAIN_FILE:-    --train_output ./datasets/nyc/preprocessed/                                                       
  train_qa_pairs_kqt_candidates_target_poi_multiview_dst_time_layered10_far4_mismatch4_tail2_testtop10.json}"

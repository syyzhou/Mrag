...
TRAIN_FILE="${TRAIN_FILE:-    --train_output ./datasets/nyc/preprocessed/train_qa_pairs_kqt_candidates_target_poi_multiview_dst_time_layered10_far4_mismatch4_tail2_testtop10.json}"
TEST_FILE="${TEST_FILE:-./datasets/nyc/preprocessed/test_qa_pairs_kqt_candidates_target_poi_multiview_dst_time_layered12_far3_mismatch3_tail2.txt}"
OUTPUT_DIR="${OUTPUT_DIR:-./output/single-lora-target-poi-multiview-dst-time-layered12-far3-mismatch3-tail2-ablation}"

...
TRAIN_FILE="./datasets/nyc/preprocessed/train_qa_pairs_kqt_candidates_target_poi_multiview_uncertain.json"
TEST_FILE="./datasets/nyc/preprocessed/test_qa_pairs_kqt_candidates_target_poi_multiview_uncertain.txt"
OUTPUT_DIR="./output/two-router-target-poi-multiview-uncertain"
SEQ_LEN=4096
DATASET_NAME="nyc"

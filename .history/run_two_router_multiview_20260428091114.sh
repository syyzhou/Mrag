...
TEST_FILE="./datasets/nyc/preprocessed/test_qa_pairs_kqt_candidates_target_poi_multiview_dropout04_wd3e3_train_random10_global10_
  shuffle_test_top20_uncertain_test_candidates_shuffled.txt"

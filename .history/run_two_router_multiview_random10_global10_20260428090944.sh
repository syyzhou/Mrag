...
TRAIN_FILE="./datasets/nyc/preprocessed/train_qa_pairs_kqt_candidates_target_poi_multiview_dropout04_wd3e3_train_random10_global10_test_top20_uncertain.json"
TEST_FILE="./datasets/nyc/preprocessed/test_qa_pairs_kqt_candidates_target_poi_multiview_dropout04_wd3e3_train_random10_global10_shuffle_test_top20_uncertain_test_candidates_shuffled.txt"
OUTPUT_DIR="./output/two-router-target-poi-multiview-dropout04-wd3e3-train-random10-global10-test-top20-uncertain"
SEQ_LEN=4096
DATASET_NAME="nyc"

...
TRAIN_FILE=" ./datasets/nyc/preprocessed/train_qa_pairs_kqt_candidates_target_poi_multiview_dropout04_wd3e3_train_random10_global10_shuffle_full_50target_uncertain.json"
TEST_FILE="./datasets/nyc/preprocessed/test_qa_pairs_kqt_candidates_target_poi_multiview_dropout04_wd3e3_train_datasets/nyc/preprocessed/train_qa_pairs_kqt_candidates_target_poi_multiview_dropout04_wd3e3_train_random12_random8_shuffle_test_top20_uncertaindatasets/nyc/preprocessed/test_qa_pairs_kqt_candidates_target_poi_multiview_dropout04_wd3e3_train_random10_global10_test_top20_uncertain.txt.txt"
OUTPUT_DIR="./output/two-router-target-poi-multiview-dropout04-wd3e3-full-50target-test-top20-original"
SEQ_LEN=4096
DATASET_NAME="nyc"

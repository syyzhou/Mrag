...
TEST_FILE="./datasets/nyc/preprocessed/test_qa_pairs_kqt_cnyc/preprocessed/test_qa_pairs_kqt_candidates_target_poi_multiview_dropout04_wd3e3_train_random10_global10_test_top20_uncertain.txt"
